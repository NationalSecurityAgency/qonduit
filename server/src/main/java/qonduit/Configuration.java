...
public class Configuration {
    ...
    @NotEmptyIfFieldSet.List({
            @NotEmptyIfFieldSet(fieldName = "useGeneratedKeypair", fieldValue = "false", notNullFieldName = "certificateFile", message = "must be set if qonduit.security.ssl.use-generated-keypair is false"),
            @NotEmptyIfFieldSet(fieldName = "useGeneratedKeypair", fieldValue = "false", notNullFieldName = "keyFile", message = "must be set if qonduit.security.ssl.use-generated-keypair is false") })
    public class Ssl {
