...
import qonduit.netty.http.HttpHandler;

public abstract class LoginRequestHandler<T> extends SimpleChannelInboundHandler<T> implements HttpHandler {
    ...
    public LoginRequestHandler(Configuration conf) {
